      ...
      <section className="relative w-full h-screen mb-8">
        ...
        <div className="absolute top-[5%] left-[5%] lg:top-[25%] mx-2">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-3 mb-4">
            ...
            <p>2019</p>
            <p>4 Seasons</p>
            <p className="bg-red-700 py-1 px-3 rounded-[6px] w-[68px]">
              Action
            </p>
            <p className="bg-gray-700 py-1 px-3 rounded-[6px] w-[118px]">
              Supernatural
            </p>
            <p className="bg-gray-700 py-1 px-3 rounded-[6px] w-[78px]">
              Shonen
            </p>
          </div>
          <p className="lg:w-[55%] lg:text-2xl">
            A young boy becomes a demon slayer to avenge his family and cure his
            demon sister. Follow Tanjiro's journey through breathtaking battles
            and emotional storytelling in this critically acclaimed series.
          </p>
      ...
      <section className="relative w-full  mt-8">
        ...
        <div className="flex flex-wrap justify-between mx-6 gap-3">
          ...
          <div className="gap-3 mr-2 lg:w-[240px] flex-row justify-center items-center bg-gray-800 py-4 px-4 rounded-2xl border-2 border-red-700 ">
            <div className="flex-row text-center mb-2 item">
              <p className="text-xl font-bold bg-red-700 py-2 px-3 rounded-xl">
                TODAY
              </p>
        ...
        <div className="mx-6 flex gap-8 flex-wrap">
          {animeCards.map(
            ({
              ...
              <div
                className={`bg-gray-700 lg:w-[15%] h-[480px] rounded-2xl cursor-pointer relative group overflow-hidden flex flex-col justify-end pb-5`}
              >
                <a href={link}>
                  <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center z-10 opacity-0 hover:opacity-100 transition-opacity">
                    <img
